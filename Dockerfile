...
# docker run -d --rm -v $XDG_RUNTIME_DIR/pulse:$XDG_RUNTIME_DIR/pulse \
# -v /media/crypto/sanjayu/:/home/user/tor-browser-data/
# -v /tmp/.X11-unix:/tmp/.X11-unix \
# -v /dev/shm:/dev/shm \
# -e DISPLAY=unix$DISPLAY \
# -e PULSE_SERVER=unix:$XDG_RUNTIME_DIR/pulse/native \
# debian-tor-browser:latest

FROM debian:buster
LABEL maintainer "Sanjay Upadhyay <saneax@gmail.com>"
...
ENTRYPOINT ["/bin/bash"]
CMD [ "/usr/local/bin/Browser/start-tor-browser", "--profile", "/home/user/tor-browser-data/", "--log", "/dev/null" ]
